...
DPMParams = namedtuple(
    "DPMParams",
    ["c", "mu_r", "mu_f", "d_r", "d_f", "tc_bound", "r_bound", "z0", "mu_r_new", "mu_f_new", "deltaT", "t_offset"],
)
...
def predicted_proportions(c, mu_r, mu_f, d_r, d_f, tc_bound, r_bound, z0, deltaT, t_offset=0, use_fftw=True):
    # make c (the confidence levels) an array in case it is a scalar value
    c = pl.array(c, ndmin=1)
    n = len(c)
    # form an array consisting of the appropriate (upper) integration limits
